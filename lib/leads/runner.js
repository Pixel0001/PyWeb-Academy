...
// Cât timp are voie să lucreze un pas înainte să se oprească frumos.
// Trebuie să fie sub `maxDuration` din ruta /step (300s pe Vercel Pro), ca să
// apucăm să salvăm progresul și să răspundem — un 504 ar pierde tot pasul.
const BUGET_PAS_MS = (CONFIG.pasi.bugetPasSecunde || 45) * 1000

// Lock-ul trebuie să fie ceva mai lung decât un pas: dacă funcția e ucisă de
// timeout, `lockedAt` rămâne setat și nimeni nu-l mai șterge, așa că după
// atâta timp îl considerăm mort și mergem mai departe.
const DURATA_LOCK_MS = BUGET_PAS_MS + 60 * 1000
